...
export class QueryConstants {
    public static readonly GetAllRaces:string = `select
                            r.id as id,
                            r.name as name,
    ...
    public static readonly GetAllRacesSignedUp:string = `SELECT
                            tbt.name
    ...
    public static readonly IndividualBookingQuery: string = `select
                            b.id as id,
     ...
     public static readonly TeamBookingQuery: string = `select
                            b.id as id,
                            b.activate as activate,
                            r.id as race_id,
                            r.name as race_name,
     ...
     public static readonly MemberBookingQuery1: string = `select
                            b.id as id,
                            b.activate as activate,
                            r.id as race_id,
                            r.name as race_name,
    ...
    public static readonly userProfileRaceHistory: string = `select
                            u.name as user_name,
    ...
    public static readonly getUserRaceDetails: string = `select
                            t.id as id,
                            r.team_score_type as team_score_type,
                            r.allow_end_race as allow_end_race,
    ...
    public static readonly checkpointStatus: string = `select
                            t.id as id,
                            t.race_id as race_id,
                            t.distance as distance,
                            if(isnull(t.updated_starpoints), t.starpoints, t.updated_starpoints) as starpoints,
    ...
    public static readonly userStatsStarpoints: string = `select
                            t.id as id,
                            r.team_score_type as team_score_type,
                            r.allow_end_race as allow_end_race,
                            t.race_id as race_id,
    ...
    public static readonly getTeamleaderboard_FirsEntry: string = `
    ...
    public static readonly getTeamleaderboard_Avg: string = `
                            SELECT result.race_id,
                                   result.team_id,
                                   result.name,
    ...
    public static readonly getTeamleaderboard_Max: string = `
                            SELECT result.race_id,
                                   result.team_id,
                                   result.name,
                                   round(sum(result.starpoints)) AS starpoints,
    ...
    public static readonly getTeamleaderboard_Sum: string =`select
    ...
    public static readonly getAllUsersLeaderboard: string = `select
    ...
    public static readonly getGivenUserLeaderboard: string = `select
                            FLOOR(sum(rst.starpoints)) as starpoints,
                            rst.user_id, rst.email,
                            rst.profile_image, rst.created_at, rst.updated_at,
                            rst.name as name
    ...
    public static readonly getLeaderboard: string = `
                            select 
                                t.user_id, t.email,
                                t.profile_image,
    ...
    public static readonly getLeaderboardDateCondition: string = `
                            select 
                                t.user_id, t.email,
                                t.profile_image,
                                t.name, t.created_at, t.updated_at,
    ...
    public static readonly getUsersRank_Team: string = `select
                            trt.id as team_id,
                            trt.name as team_name,
                            avg(turs.end_date-start_date) as time_difference,
    ...
    public static readonly getUsersRank_Individual: string = `select
                            u.id as user_id,
                            u.name as name,
    ...
    public static readonly getChallenges_physical: string = `select
                            tqc.id as id,
    ...
    public static readonly getChallenges_quiz: string = `select
                            tpc.id as id,
    ...
    public static readonly getChallenges_special: string = `select
                            tspc.id as id,
    ...
    public static readonly getAdminAllPremiumRaces: string = `select
                            r.id as id,
                            r.name as name,
                            r.team_score_type as team_score_type,
                            r.allow_end_race as allow_end_race,
    ...
    public static readonly getAdminAllPremiumPaidRaces: string = `select
                            r.id as id,
                            r.name as name,
                            r.team_score_type as team_score_type,
                            r.allow_end_race as allow_end_race,
    ...
    public static readonly getAdminAllPracticeRaces: string = `select
                            r.id as id,
                            r.name as name,
                            r.team_score_type as team_score_type,
                            r.allow_end_race as allow_end_race,
    ...
    public static readonly GetRaceCheckpoints:string = `select
    ...
    public static readonly getSinglePremiumRaceDetails: string = `select
                            r.id as id,
                            r.name as name,
                            r.team_score_type as team_score_type,
                            r.allow_end_race as allow_end_race,
    ...
    public static readonly getSinglePremiumPaidRaceDetails: string = `select
                            r.id as id,
                            r.name as name,
                            r.team_score_type as team_score_type,
                            r.allow_end_race as allow_end_race,
    ...
    public static readonly getSinglePracticeRaceDetails: string = `select
                            r.id as id,
                            r.name as name,
                            r.price as price,
                            r.featured as featured,
    ...
    public static readonly userTeamStarpoints:string =  `select
                            trt.name as team_name,
    ...
    public static readonly achievedStarpoints:string =  `select starpoints from table_user_race_challenge_history where user_stats_id =`

    public static readonly userTeamId:string =  `select team_id from table_race_participants where team_id is not null and user_id =`

    public static readonly teamStarpoints:string =  `
    ...
    public static readonly teamId:string =  `select ts.team_id, ts.user_stats_id, ts.status from (select u.id as user_id,
    ...
    public static readonly userStatsId:string =  `select
                            t.id
                            from table_user_race_stats t
    ...
    public static readonly teamBookingDetails:string =  `select
                            b.id as id,
                            r.id as race_id,
                            r.name as race_name,
                            r.team_score_type as team_score_type,
    ...
    public static readonly getRaceInvitationCodeList: string = `select
    ...
    public static readonly getRaceParticipants: string = `select
    ...
    public static readonly getMaxAvailableStarPoints: string = `
    ...
    public static readonly usersRaceLeaderboardStatistical: string = `
                            select
                                rh.race_id,
                                rh.user_id,
